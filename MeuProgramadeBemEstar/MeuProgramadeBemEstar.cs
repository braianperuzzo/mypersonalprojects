...
namespace MeuProgramadeBemEstar
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            {
                await RunProgram(); // Chama a função RunProgram para executar o programa principal
            }
        }
       static async Task RunProgram()

        {
            ...
            else if (sEstadodeSaude == "2") // Se o estado de saúde informado for "2"
            {
                ...
                await ExibirImagensAutomaticamente.ExibirImagensAutomaticamenteProcedimento();
        ...
        {
            public static async Task ExibirImagensAutomaticamenteProcedimento()
            {
                while (true)
                {
